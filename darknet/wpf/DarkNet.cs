...
namespace darknet.wpf {
    ...
    ///     <para>Be sure to call both <see cref="SetDarkModeAllowedForProcess" /> before showing any windows in your app, and then call <see cref="SetDarkModeAllowedForWindow" /> in each of your windows' <see cref="Window.SourceInitialized" /> events.</para>
    /// </summary>
