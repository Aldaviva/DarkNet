...
namespace DarkNet.WPF {
    ...
    ///     <para>Be sure to call both <see cref="SetCurrentProcessTheme" /> before showing any windows in your app, and then call <see cref="SetWindowTheme" /> in each of your windows' <see cref="Window.SourceInitialized" /> events.</para>
    /// </summary>
    /// <remarks>Requires Windows 10 version 1809 or later.</remarks>
    public class DarkNetWpfImpl: AbstractDarkNet<Window>, DarkNetWpf {

        private static readonly Lazy<DarkNetWpfImpl> LazyInstance = new();
        public static DarkNetWpf Instance => LazyInstance.Value;
        ...
        public override void SetWindowTheme(Window window, Theme theme) {
