...
namespace DarkNet {
    ...
    public interface DarkNet<in TWindow> {
        ...
        void SetWindowTheme(TWindow window, Theme theme);

        bool IsSystemDarkTheme { get; }
        event IsSystemDarkThemeChangedEventHandler? IsSystemDarkThemeChanged;

    }

    public delegate void IsSystemDarkThemeChangedEventHandler(object sender, bool isSystemDarkTheme);
