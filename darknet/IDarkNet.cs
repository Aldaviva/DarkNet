...
/// <summary>
/// <para>Interface of the DarkNet library. Used for making title bars of your windows dark in Windows 10 and later.</para>
/// <para>Usage:</para>
/// <list type="number">
...
/// <item><description>Call <see cref="SetCurrentProcessTheme"/> before showing any windows in your process, such as in a <see cref="System.Windows.Application.Startup"/> event handler for your WPF process, or at the beginning of Main in your Forms app.</description></item>
...
public interface IDarkNet: IDisposable {
    ...
    ///     <para>Call this when your process starts, before you show any windows.</para>
    ...
    ///     <para>This method doesn't actually make your title bars dark. It is a prerequisite for calling <see cref="SetWindowThemeWpf" />/<see cref="SetWindowThemeForms"/> for each of your windows once you have created them.</para>
    /// </summary>
    ...
    /// <exception cref="InvalidOperationException">If this method was called after creating or showing any windows in your app. It has to be called before that, e.g. as the first statement in <c>OnStartup</c> or <c>Main</c>.</exception>
    ...
    /// <param name="theme">The theme to use for this window, or <see cref="Theme.Auto"/> to inherit from the app (defined by the theme passed to <see cref="SetCurrentProcessTheme"/>) or the user's default app settings if you also set the app to <see cref="Theme.Auto"/> (defined in Settings › Personalization › Colors).</param>
