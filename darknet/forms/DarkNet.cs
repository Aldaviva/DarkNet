...
namespace darknet.forms {
    ...
    ///     <para>Be sure to call both <see cref="SetDarkModeAllowedForProcess" /> before showing any windows in your app, and then call <see cref="SetDarkModeAllowedForWindow" /> before showing each window.</para>
    /// </summary>
    ...
    public static class DarkNet {
        ...
        ///     <para>This method doesn't actually enable dark mode for your windows, it is a prerequisite for calling <see cref="SetDarkModeAllowedForWindow" /> for each of your windows once you have created them.</para>
        /// </summary>
        ...
        ///     <para>You must have already called <see cref="SetDarkModeAllowedForProcess" /> before creating this window.</para>
        ...
        public static void SetDarkModeAllowedForWindow(Form window, bool isDarkModeAllowed) {
